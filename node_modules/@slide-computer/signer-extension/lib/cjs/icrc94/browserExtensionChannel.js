...
exports.BrowserExtensionChannel = void 0;
const signer_1 = require("@slide-computer/signer");
const browserExtensionTransport_1 = require("./browserExtensionTransport");
class BrowserExtensionChannel {
    ...
    async send(request) {
        if (__classPrivateFieldGet(this, _BrowserExtensionChannel_closed, "f")) {
            throw new browserExtensionTransport_1.BrowserExtensionTransportError("Communication channel is closed");
        }
        const response = await __classPrivateFieldGet(this, _BrowserExtensionChannel_options, "f").providerDetail.sendMessage(request);
        if (!(0, signer_1.isJsonRpcResponse)(response)) {
            return;
        }
...
exports.BrowserExtensionChannel = BrowserExtensionChannel;
