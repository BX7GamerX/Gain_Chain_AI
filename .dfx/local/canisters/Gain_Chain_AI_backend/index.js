...
import { idlFactory } from './Gain_Chain_AI_backend.did.js';
export { idlFactory } from './Gain_Chain_AI_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GAIN_CHAIN_AI_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Gain_Chain_AI_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Gain_Chain_AI_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Gain_Chain_AI_backend.did.js")._SERVICE>}
 */
export const Gain_Chain_AI_backend = createActor(canisterId);
