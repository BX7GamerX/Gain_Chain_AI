...
import { idlFactory } from './Gain_Chain_AI_frontend.did.js';
export { idlFactory } from './Gain_Chain_AI_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GAIN_CHAIN_AI_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Gain_Chain_AI_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Gain_Chain_AI_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Gain_Chain_AI_frontend.did.js")._SERVICE>}
 */
export const Gain_Chain_AI_frontend = createActor(canisterId);
